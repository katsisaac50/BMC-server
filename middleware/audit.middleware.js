...
var auditMiddleware = function (action, entity) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var oldJson;
        return __generator(this, function (_a) {
            oldJson = res.json;
            res.json = function (body) { return __awaiter(void 0, void 0, void 0, function () {
                var logData, error_1;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, AuditLog_1.default.create(logData)];
                        case 1:
                            _c.sent();
                            return [3 /*break*/, 3];
                        case 2:
                            ...
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/, oldJson.call(res, body)];
                    }
                });
            }); };
            next();
